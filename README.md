...
My career path at the moment leads me to touch on both systems and audio-video topics related to the broadcast world. 

👋 My experience led me to learn about topics such as playout management, ingest maintenance, export of useful content to the customer, maintenance of audio-video formats useful for broadcasting, maintenance of workstations suitable for video editing, knowledge of various workflows to allow the use of contents within audio video systems, resolution of errors in video projects to allow the rendering and broadcasting of projects. My goal is always to improve and become a better professional in my industry by sharing my knowledge with others so that there is a mutual exchange. 
